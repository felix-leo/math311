################################################################
## 
## Simple implementation of some Newton-Cotes Composite Methods
##   Given for ease of understanding
##
################################################################

simple_midpt = function(a,b,f,n) {
...
simple_trapezoid = function(a,b,f,n) {
...
simple_simpsons = function(a,b,f,n) {
